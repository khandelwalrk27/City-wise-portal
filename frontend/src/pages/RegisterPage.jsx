    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-10">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl border border-slate-200 shadow-xs space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Create CityWise Account</h2>
          <p className="text-xs text-slate-500 font-medium">Join Jaipur Civic Resolution Network</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-white border border-slate-300 rounded-xl px-3 py-2.5 text-xs text-slate-900 focus:outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600"
            >
              <option value="CITIZEN">Citizen (Report & Verify Issues)</option>
